...
%
$$\chi_2(V)\circ {\I^{g'}(\Phi(V))} = \etaunshriek_{p'_2,\Phi(X),\Phi(V)}({\bf\Phi}_2^2(\etashriek_{p_2,X,V}(\id_{X}))) \circ \I^{g'}(\Phi(V))$$
%
by definition of $\chi_2(V)$ in \cite[Construction 5.6]{fromunivwithPi}. Then we have:
%
\begin{align*}
  \etaunshriek_{p'_2,\Phi(X),\Phi(V)}&({\bf\Phi}_2^2(\etashriek_{p_2,X,V}(\id_X))) \circ \I^{g'}(\Phi(V)) \\
...
%
$$\etaunshriek_{p'_1,\Phi(X),\Phi(V)}({\bf\Phi}_1^2(\etashriek_{p_1,X,V}(\I^g(V)))=\Phi(\I^g(V))\circ \chi_1(V)$$
%
Let $a$ be any element of $Hom(\I_{p_2}(V),\I_{p_1}(V))$.  It will suffice to show that
%
$$\etaunshriek_{p'_1,\Phi(X),\Phi(V)}({\bf\Phi}_1^2(\etashriek_{p_1,X,V}(a))=\Phi(a)\circ \chi_1(V).$$
%
We have
%
\begin{align*}
