...
%
\begin{eq}
\label{2015.04.04.eq1} Jp \circ \I^{\omega}(\wt{\U})= Jp \circ coJ\circ
\prI_p(\wt{\U})=\prI_{p}(\wt{\U})
\end{eq}%
%
\begin{eq}
\label{2015.04.04.eq2} Jp \circ \I_{pE\wt{\U}}(p)=Jp \circ coJ\circ
\prI_{pE\wt{\U}}(\U)=\prI_{pE\wt{\U}}(\U),
\end{eq}%
%
where $\prI_p(V)$ was defined in \ref{eq:def-prI}.
