...
\newcommand{\Id}{\mathsf{Id^1}} % originally was "IdT"
\newcommand{\Idx}{\mathsf{Id^3}} % originally was "IdxT"
...
\begin{align*}
  ...
  \wt{\psi} & :\D_{pE\wt{\U}}(int(\Gamma),\wt{\U})\sr \wt{Ob}(\toCC({\C},p))
\end{align*}
%
such that
%
...
$\wt{Ob}(\toCC({\C},p))$ that satisfies the equation
%
...
%
\begin{enumerate}
\item Let $\Id$, $IdT'$ are J0-structures on $\CC$ and $CC'$ respectively.  Then
...
\item Let $\Id$, $IdT'$ be as above and let $\refl$, $refl'$ be J1-structures
  ...
  J0-structures $H:(\CC,\Id)\sr (CC',IdT')$ is called a homomorphism of
  C-systems with J1-structures
%
$$(\CC,\Id,\refl)\sr (CC',IdT',refl')$$
%
...
\wt{Ob}(\rf_T^*(P))$. Equivalently we can say that $Jdom(\CC,\Id,\refl)$ is the
...
$\Gamma\in Ob(\toCC({\C},p))$ and $o,o'\in \wt{Ob}_1(\Gamma)$ such that
