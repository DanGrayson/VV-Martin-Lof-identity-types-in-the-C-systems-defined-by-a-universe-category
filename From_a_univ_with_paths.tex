...
$$H(\rf_T^*(P))=H(\rf_T)^*(H(P))$$
%
It remains to show that $H(\Idx(T))=\Idx'(H(T))$ and $H(\rf_T)=\rf_{H(T)}'$. This
...
let $\Idx'$ be the analogue, for the category $\C'$, of $\Idx$;
...
\begin{align*}
    ...
    & = \p^{E'}_{int'(H(T))} \circ \psi_{\Gamma}, & \text{$\p^{E'}_{int'(H(T))}$ is undefined (?)} % TO DO
\end{align*}
%
equation \ref{eqn-11a} reduces to
%
\begin{eq}
...
\begin{align*}
  \Q(\psi_{\Gamma}\circ \Phi&(F)\circ \phi)_{E'}\circ \p_{(\wt{\U}';p'),Eq'}\circ \Q(p') \\
    ...
    & = \p_{\Idx'(H(T))}\circ \Q(\Q(F'),p')\circ \Q(p') & \by{commutativity of \ref{2015.05.08.constr1}} \\
    & = \p_{\Idx'(H(T))}\circ \Q(\Q(F')\circ p') & \by{commutativity of \ref{2015.04.06.l0.sq}} \\
    & = \p_{\Idx'(H(T))}\circ \Q(u_1(\ft(\Idx(H(T))))).
\end{align*}
\end{myproof}
...
\begin{align*}
  \psi_{\Gamma}\circ \etaunshriek_{pE\wt{\U}'}&({\bf\Phi}^2_E(F,G))\circ \I_{pE\wt{\U}'}(\phi) \\
    ...
    & = \etaunshriek_{pE\wt{\U}'}((u_{1,H(\Gamma)}'(H(T)),u_{1,\Idx'(H(T))}(H(P)))),
\end{align*}
%
...
%
where $F'=u_{1,H(\Gamma)}(H(T))$ and $G'=u_{1,\Idx'(H(\Gamma))}(H(P))$.  This
