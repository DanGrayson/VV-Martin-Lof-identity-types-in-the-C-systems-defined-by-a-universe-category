...
Next we have
%
$$I_{pE\wt{\U}}(p)=\uu{Hom}_\U((E\wt{\U},pE\wt{\U}),Id_\U\times p)$$
$$I^{\omega}(\wt{\U})=\uu{Hom}_\U(\omega,(\U\times\wt{\U},pr_2))$$
%
...
\begin{xy}
          \xymatrix@C=2pc{ Z \ar[r]^-{f_Z} \ar[d]_{i} &
            \uu{Hom}_\U((\wt{\U},p),(\U\times V,pr_1)) \ar[d]^{pr}\\ W
            \ar[r]^-{f_W} & \U }
\end{xy}
$$
%
We need to construct a morphism $f:W\sr \uu{Hom}_\U((\wt{\U},p),(\U\times
...
\begin{xy}
          \xymatrix@C=4pc{ Z \ar[r]^-{f_Z} \ar[d]_{i} &
            \uu{Hom}_\U((\wt{\U},p),(\U\times V',pr_1))
            \ar[d]^{\uu{Hom}_\U((\wt{\U},p), Id_\U\times r)}\\ W \ar[r]^-{f_W} &
            \uu{Hom}_\U((\wt{\U},p), (\U\times V, pr_1)) }
\end{xy}
\end{eq}
%
...
%
$$adj(f_Z)\circ (Id_\U\times r )=adj(f_Z\circ \uu{Hom}_\U((\wt{\U},p), Id_\U\times
r))=$$
...
$f:W\sr \uu{Hom}_\U((\wt{\U},p),(\U\times V',pr_1))$. Let us show that $f$ splits
the square (\ref{2015.05.14.sq1}) into two commutative triangles i.e. that we
have $i\circ f= f_Z$ and $f\circ \uu{Hom}_\U((\wt{\U},p), Id_\U\times r)=f_W$.
...
The second equality is equivalent to $adj(f\circ \uu{Hom}_\U((\wt{\U},p),
