...
%
and we have constructed in \cite[Construction 2.6.4]{fromunivwithPiI} a family of
...
$$
%
commutes, where the left hand vertical arrow is defined by
%
...
%
\begin{myproof}
We abbreviate $\etashriek_{p,X,V}$ as $\etashriek$ and $\etashriek_{p',X,V}$ as $\eta^{',!}$.
Since $\etaunshriek$ is defined as an inverse to $\etashriek$ it is sufficient to show that
for any $g\in Hom(X,\I_p(V))$ one has $\eta^{',!}(g\circ \I^f(V))=D^f(X,V)(\etashriek(g))$.
Let
%
\begin{align*}
