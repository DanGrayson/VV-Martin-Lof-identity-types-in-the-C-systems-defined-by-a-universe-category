...
projections being $\p_{\p_T^*(T)}$ and $\Q(\Q(F)\circ p)$, to prove
...
\begin{align}
  ...
  \rf_T\circ v \circ \Q(\Q(F)\circ p) & = F^*(\omega)\circ v \circ \Q(\Q(F)\circ p) \label{eqn44}
\end{align}
...
\begin{align*}
  ...
  & = \Q(F) \circ \Delta \circ \p_{\wt{\U},p}            & \by{...} \\
  & = \Q(F)\circ \omega \circ pE\wt{\U} \circ \p_{\wt{\U},p}            & \by{...} \\
  & = F^*(\omega) \circ h_1 \circ pE\wt{\U} \circ \p_{\wt{\U},p}        & \by{...} \\
  & = F^*(\omega) \circ v \circ \Q(\Q(F) \circ p) \circ \p_{\wt{\U},p}  & \by{...} \\
  & = F^*(\omega) \circ v \circ \p_{\p_T^*(T)}    \circ \Q(F)           & \by{...}
\end{align*}
