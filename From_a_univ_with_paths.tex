...
\begin{eq}
  ...
  \begin{xy}
    \xymatrix@C=5pc{
      ...
      \ar@/^1.5pc/[rrrd]^{\Q'_i(\Phi(F_1)\circ\phi)}
...
\begin{align*}
  ...
  & = \iota_1\circ \Phi(\Q_1(F_1)\circ g)\circ \wt{\phi}_2  & \by{$\Phi$ being a functor} \\
  & = \iota_1\circ \Phi(F_1^*(g)\circ \Q_2(F_1))\circ \wt{\phi}_2 & \by{\ref{2015.04.08.eq3}} \\
  & = \iota_1\circ \Phi(F_1^*(g))\circ \Phi(\Q_2(F_1))\circ\wt{\phi}_2 & \by{$\Phi$ being a functor}
\end{align*}
...
\begin{align*}
  ...
  & = \iota_1\circ \Phi(F_1^*(g))\circ \Phi(\p_{2,X,F_1}) & \by{$\Phi$ being a functor}
\end{align*}
\end{myproof}
