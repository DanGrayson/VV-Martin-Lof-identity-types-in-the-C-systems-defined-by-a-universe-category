...
\begin{align*}
  \psi_{\Idx(T)}\circ \Phi&(\Q(F)_E)\circ \Phi(\p_{(\wt{\U};p),Eq})\circ \Phi(\Q(p))\circ \wt{\phi} \\
    ...
    & = \p_{\Idx'(H(T))}\circ \Q'(u_1(H(\ft(\Idx(T)))))                                                 & \by{\ref{HIdxT-eqn}} \\
    & = \p_{\Idx'(H(T))}\circ \Q'(u_1(\ft(H(\Idx(T)))))                                                 & \by{\ref{ft-H-eqn}} \\
...
%
\begin{align}
  \phi(H(\Gamma),H(T),H(P),H(s0)) \circ \pr_1 &=\etaunshriek_{pE\wt{\U}'}(F',G')          \label{phiGTPs-defn1'} \\
  \phi(H(\Gamma),H(T),H(P),H(s0)) \circ \pr_2 &=\etaunshriek_{p'}        (F',\wt H'),     \label{phiGTPs-defn2'}
\end{align}
%
where
%
