...
We have constructed in \cite[Construction 2.6.4]{presheavesOb} a family of
...
of projections as an object over $\U$, and let $\gls{pEUtilde}a$ denote it.
...
\begin{align*}
  \rf_T \circ h
  & = \refl(\delta(T))\circ \q(\delta(T),\Idx(T))         \circ h & \by{def'n \ref{2015.04.02.eq1}} \\
  & = \refl(\delta(T))\circ \Q(\delta(T),\Q(\Q(F),p)      \circ Eq) \circ h & \by{\ref{2015.04.02.eq2} and \ref{2015.03.27.l1-IDx}} \\
  & = \refl(\delta(T))\circ \Q(\delta(T),\Q(\Q(F),p)      \circ Eq) \circ \Q(\Q(\Q(F),p)\circ Eq) & \by{def'n of $h$} \\
  & = \refl(\delta(T))\circ \Q(\delta(T)\circ \Q(\Q(F),p) \circ Eq) & \by{\ref{2015.04.06.l0.sq}}\\
  & = \refl(\delta(T))\circ \Q(\Q(F)\circ \Delta          \circ Eq) & \by{\ref{diag3}}\\
  & = \refl(\delta(T))\circ \Q(\Q(F)\circ \Omega          \circ p) & \by{\ref{2015.03.27.sq1}}
\end{align*}
%
On the other hand
...
\begin{align*}
  F^*(\omega) \circ h & = F^*(\omega) \circ h_1 \circ h_2 & \by{def'n of $h$} \\
                      & = \Q(F) \circ \omega \circ h_2    & \by{...} \\
                      & = \Q(F) \circ \omega \circ \Q(Eq) & \by{...} \\
                      & = \Q(F) \circ \Omega              & \by{...}
\end{align*}
...
\begin{align*}
    ...
    & = \delta(T) \circ \Q(\Q(F) \circ p)      & \by{...} \\
    & = \delta(T) \circ \Q(\p_T \circ F)       & \by{...} \\
    & = \delta(T) \circ \q(\p_T,T) \circ \Q(F) & \by{...} \\
    & = \id_{int(T)} \circ \Q(F)               & \by{...} \\
    & = \Q(F)                                  & \by{...}
\end{align*}
%
