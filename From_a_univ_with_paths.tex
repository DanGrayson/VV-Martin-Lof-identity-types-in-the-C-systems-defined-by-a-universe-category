...
To define the J-structure on a C-system $\aCC$ we will actually define three
...
\cite[\S 3]{fromunivwithPiI}, as well as \cite[\S 3]{Csubsystems} for
$\gls{partial}(o)$.  We recall that $\Ob_n(\Gamma)$ is the set of objects
$\Delta$ of $\aCC$ such that $l(\Delta)-n = \Gamma$ and $\ft^n(\Delta) = \Gamma$, and that
$\Obwt_n(\Gamma)$ denotes the set of morphisms of the form
$o : \ft(\Delta) \sr \Delta$ for some $\Delta \in \Ob_n(\Gamma)$ that are
sections of the corresponding canonical projection, i.e., where
$o \circ p_\Delta$ is an identity morphism; in that case $\partial(o)$ denotes $\Delta$.
...
$$E\wt{\U}:=(\wt{\U};p,Eq)$$
of $\mathcal C$ together with the composite
