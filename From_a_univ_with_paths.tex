...
\end{align*}
%
be given by the compositions $\zeta_{\bf\Phi} := \chi_{{\bf\Phi}_{E}}(\U)\circ \I_{pE\wt{\U}'}(\phi)$
and $\wt{\zeta}_{\bf\Phi} := \chi_{{\bf\Phi}_{E}}(\wt{\U})\circ \I_{pE\wt{\U}'}(\wt{\phi})$; don't confuse these maps
with $\zeta_i$ and $\wt\zeta_i$, which were introduced above. Note that
...
%
\begin{align*}
  F&=u_{1,\Gamma}(T)           & F'&=u_{1,H(\Gamma)}(H(T))         \\
  G&=u_{1,\Idx(T)}(P)          & G'&=u_{1,\Idx'(H(T))}(H(P))       \\
...
\begin{align*}
    ...
    & = \psi_{\Gamma}\circ\etaunshriek_{pE\wt{\U}'}({\bf\Phi}^2_E(F,G))\circ \I_{pE\wt{\U}'}(\phi),                 & \by{\cite[Lemma 5.8]{fromunivwithPi} -- VERIFY} \\
...
\begin{align*}
  \psi_{\Gamma}\circ \Phi&(\phi(\Gamma,T,P,s0))\circ R_{\Phi}\circ \pr_2'  \\
    ...
    & = \psi_{\Gamma}\circ \Phi(\etaunshriek_p(u_{2,\Gamma}(s0)))\circ \wt{\xi}_{\Phi} \\
    & = \etaunshriek_{p'}(\wt{u}_{2,H(\Gamma)}'(H(s0)))                                     & \by{\cite[Lemma 6.2(2)]{fromunivwithPi}} \\
    & = \etaunshriek_{p'}((F',\wt H'))                                                      &  \\
